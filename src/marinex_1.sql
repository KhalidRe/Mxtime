...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 02 jan 2022 kl 14:19
...
(81, 'aa', '48', '2021-12-25', '', '2021-12-24'),
(82, 'gsg', '0', '2021-12-30', 'Khalid', '2021-12-23'),
(83, 'ggg', '32', '2021-12-24', 'Khalid', '2021-12-23'),
(84, 'hh', '71', '2021-12-24', 'Khalid', '2021-12-23'),
(85, 'geag', '58', '2021-12-25', 'Khalid', '2021-12-23'),
(86, 'geag', '0', '2021-12-24', 'Khalid', '2021-12-24'),
(87, 'geag', '0', '2021-12-25', 'Khalid', '2021-12-24'),
(88, 'geag', '0', '2021-12-26', 'Khalid', '2021-12-24'),
(89, 'geag', '46', '2021-12-26', 'Khalid', '2021-12-24'),
(90, 'ff', '47', '2021-12-25', 'Khalid', '2021-12-24'),
(91, 'Löölll', '51', '2021-12-24', 'Khalid', '2021-12-23'),
(92, 'okok', '78', '2022-01-01', 'Khalid', '2021-12-23'),
(93, 'aeq', '100', '2021-12-22', 'Khalid', '2021-12-23'),
(94, 'okok', '100', '2022-01-01', 'Khalid', '2021-12-23'),
(95, 'okok', '67', '2022-01-01', 'Khalid', '2021-12-23');
...
--
-- Tabellstruktur `fakturerat`
--

CREATE TABLE `fakturerat` (
  `id` int(11) NOT NULL,
  `Title` varchar(255) DEFAULT NULL,
  `Author` varchar(255) DEFAULT NULL,
  ...
  `Belopp` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `projects` (`id`, `Title`, `Author`, `Date`, `Deadline`, `Workers`, `Completed`, `Precentage`) VALUES
(1, 'ff', 'Khalid', '2021-12-24', '2021-12-25', 'Ljung', 'NEJ', 47),
(2, 'Löölll', 'Khalid', '2021-12-23', '2021-12-24', 'Philip', 'NEJ', 51),
(3, 'okok', 'Khalid', '2021-12-23', '2022-01-01', 'Kvist', 'NEJ', 67),
(4, 'aeq', 'Khalid', '2021-12-23', '2021-12-22', 'Anders', 'NEJ', 100);
...
INSERT INTO `users` (`id`, `Username`, `Password`, `Name`, `Active`, `Created`, `Completion`, `Profile`, `Status`) VALUES
(1, 'MXboss', '4{caGM2j`a#@$j83', 'Ljung', 1, 0, 0, 'Ljung.jpg', 'Admin'),
(2, 'MXkvist', 'TLk=?7zjX,V?PX{j', 'Kvist', 1, 0, 0, 'Kvist.jpg', 'Student'),
(3, 'MXanders', 'xZM.%y9U!F7;~Q}h', 'Anders', 1, 0, 0, 'Anders.jpg', 'Student'),
(4, 'MXphilip', 'kr3fG3(@X95{_>5;', 'Philip', 1, 0, 0, 'Philip.jpg', 'Student'),
(5, 'MXkhalid', 'C~%!XZh!9vy}C8xk', 'Khalid', 4, 4, 0, 'Khalid.jpg', 'Student');
...
--
-- Index för tabell `fakturerat`
--
ALTER TABLE `fakturerat`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT för tabell `fakturerat`
--
ALTER TABLE `fakturerat`
